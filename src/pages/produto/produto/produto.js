        ...
        <Menu/>
            <div>
                <Card style={{ width: '15rem' }} styleName="produto">
                    ...
                    <Card.Body>
                        <Card.Title id="titulo" name="titulo" styleName="text title">{localStorage.getItem('titulo')}</Card.Title>
                        <div className="row">
                            <div className="col-6 pt-2">
                                <Card.Text styleName="text">R${localStorage.getItem('valor')}</Card.Text>
                            </div>
                            <div className="col-6">
